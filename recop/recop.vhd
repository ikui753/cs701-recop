...
-- CREATED		"Sat May 18 12:52:54 2024"
...
SIGNAL	dpcr_wr_ALTERA_SYNTHESIZED :  STD_LOGIC;
...
SIGNAL	rx_sel_ALTERA_SYNTHESIZED :  STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL	rxData_ALTERA_SYNTHESIZED :  STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL	rz_sel_ALTERA_SYNTHESIZED :  STD_LOGIC_VECTOR(3 DOWNTO 0);
...
SIGNAL	sop_wr_ALTERA_SYNTHESIZED :  STD_LOGIC;
...
BEGIN 
am <= SYNTHESIZED_WIRE_2;
storedData <= SYNTHESIZED_WIRE_1;
...
PORT MAP(clock => clk_ALTERA_SYNTHESIZED,
		 ...
		 state => state_ALTERA_SYNTHESIZED,
		 address_method => SYNTHESIZED_WIRE_2,
		 opcode => opcode_ALTERA_SYNTHESIZED,
		 operand => operand,
		 rx => rx_sel_ALTERA_SYNTHESIZED,
		 rz => rz_sel_ALTERA_SYNTHESIZED);
...
PORT MAP(clk => clk_ALTERA_SYNTHESIZED,
		 ...
		 sel_x => rx_sel_ALTERA_SYNTHESIZED,
		 sel_z => rz_sel_ALTERA_SYNTHESIZED,
...
PORT MAP(clk => clkIn,
		 ...
		 dpcr_wr => dpcr_wr_ALTERA_SYNTHESIZED,
		 wren => wren_ALTERA_SYNTHESIZED,
		 sop_wr => sop_wr_ALTERA_SYNTHESIZED,
		 addrSel => addrSel_ALTERA_SYNTHESIZED,
...
present_sz_jmp <= present_sz_jmp_ALTERA_SYNTHESIZED;
rf_sel <= rf_sel_ALTERA_SYNTHESIZED;
rx_sel <= rx_sel_ALTERA_SYNTHESIZED;
rxData <= rxData_ALTERA_SYNTHESIZED;
rz_sel <= rz_sel_ALTERA_SYNTHESIZED;
rzData <= rzData_ALTERA_SYNTHESIZED;
sip_r <= sip_r_ALTERA_SYNTHESIZED;
state <= state_ALTERA_SYNTHESIZED;
