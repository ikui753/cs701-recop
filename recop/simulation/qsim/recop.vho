...
SIGNAL \inst7|ALT_INV_Mux11~0_combout\ : std_logic;
...
\inst7|ALT_INV_Mux11~0_combout\ <= NOT \inst7|Mux11~0_combout\;
...
PORT MAP (
	...
	sclr => \reset~input_o\,
	ena => \inst|out_count[2]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst|out_count\(2));
...
-- Equation(s):
-- \inst7|Mux11~0_combout\ = ( !\inst2|opcode\(1) & ( !\inst2|opcode\(0) & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & !\inst2|opcode\(2)))) ) ) )
...
-- Equation(s):
-- \inst7|increment\(0) = ( \inst7|increment\(0) & ( \inst7|Mux11~0_combout\ & ( \inst3|rz_recv~q\ ) ) ) # ( !\inst7|increment\(0) & ( \inst7|Mux11~0_combout\ & ( \inst3|rz_recv~q\ ) ) ) # ( \inst7|increment\(0) & ( !\inst7|Mux11~0_combout\ ) )
...
-- pragma translate_on
PORT MAP (
	datad => \inst3|ALT_INV_rz_recv~q\,
	datae => \inst7|ALT_INV_increment\(0),
	dataf => \inst7|ALT_INV_Mux11~0_combout\,
	combout => \inst7|increment\(0));

\inst|out_count[2]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst|out_count[2]~0_combout\ = (\reset~input_o\) # (\inst7|increment\(0))
...
-- Equation(s):
-- \inst7|rf_sel[3]~0_combout\ = (!\reset~input_o\ & (\inst7|Mux11~0_combout\ & ((\inst2|address_method\(0)) # (\inst2|address_method\(1)))))
...
PORT MAP (
	...
	datad => \inst7|ALT_INV_Mux11~0_combout\,
