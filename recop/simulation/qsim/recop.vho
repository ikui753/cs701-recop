...
GENERIC MAP (
	...
	logical_ram_name => "memory:inst1|altsyncram:memory_rtl_1|altsyncram_ldr1:auto_generated|ALTSYNCRAM",
...
GENERIC MAP (
	...
	init_file => "db/recop.ram0_memory_e411fb78.hdl.mif",
	init_file_layout => "port_b",
	logical_ram_name => "memory:inst1|altsyncram:memory_rtl_0|altsyncram_ldr1:auto_generated|ALTSYNCRAM",
	mixed_port_feed_through_mode => "old",
	operation_mode => "dual_port",
	port_a_address_clear => "none",
	port_a_address_width => 4,
