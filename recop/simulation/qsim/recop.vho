...
SIGNAL \inst9|operand_2[1]~1_combout\ : std_logic;
...
SIGNAL \inst9|operand_2[0]~0_combout\ : std_logic;
...
SIGNAL \inst7|ALT_INV_Equal2~0_combout\ : std_logic;
...
SIGNAL \inst9|ALT_INV_operand_2[1]~1_combout\ : std_logic;
...
SIGNAL \inst9|ALT_INV_operand_2[0]~0_combout\ : std_logic;
...
\inst7|ALT_INV_Equal2~0_combout\ <= NOT \inst7|Equal2~0_combout\;
...
\inst9|ALT_INV_operand_2[1]~1_combout\ <= NOT \inst9|operand_2[1]~1_combout\;
...
\inst9|ALT_INV_operand_2[0]~0_combout\ <= NOT \inst9|operand_2[0]~0_combout\;
...
-- Equation(s):
-- \inst7|WideOr3~combout\ = (((\inst7|nextState.memory~q\) # (\inst7|nextState.aluOperation~q\)) # (\inst7|nextState.writeback~q\)) # (\inst7|nextState.loadAluResult~q\)
...
-- Equation(s):
-- \inst7|WideOr4~combout\ = (((\inst7|nextState.decode~q\) # (\inst7|nextState.aluOperation~q\)) # (\inst7|nextState.fetch2~q\)) # (\inst7|nextState.loadAluResult~q\)
...
-- Equation(s):
-- \inst7|WideOr5~combout\ = (((\inst7|nextState.fetch~q\) # (\inst7|nextState.decode~q\)) # (\inst7|nextState.writeback~q\)) # (\inst7|nextState.loadAluResult~q\)
...
-- Equation(s):
-- \inst1|Mux13~0_combout\ = ((\inst|out_count\(1)) # (\inst|out_count\(2))) # (\inst|out_count\(3))
...
-- Equation(s):
-- \inst1|Mux4~0_combout\ = (!\inst|out_count\(3) & ((!\inst|out_count\(2) & (!\inst|out_count\(1) & \inst1|memory[0][11]~q\)) # (\inst|out_count\(2) & (\inst|out_count\(1)))))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001010000010000000101000001000000010100000100000001010000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
	datab => \inst|ALT_INV_out_count\(2),
	datac => \inst|ALT_INV_out_count\(1),
	datad => \inst1|ALT_INV_memory[0][11]~q\,
...
-- Equation(s):
-- \inst7|Selector5~0_combout\ = ((!\inst7|nextState.idle~q\) # ((\inst7|nextState.writeback~q\ & !\inst7|OUTPUTS~0_combout\))) # (\inst7|nextState.loadAluResult~q\)
...
-- Equation(s):
-- \inst7|nextState~11_combout\ = (\inst7|nextState.writeback~q\ & \inst7|OUTPUTS~0_combout\)
...
-- Equation(s):
-- \inst7|Selector0~0_combout\ = ( \inst2|opcode\(1) & ( \inst2|opcode\(0) & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & !\inst2|opcode\(2)))) ) ) ) # ( !\inst2|opcode\(1) & ( !\inst2|opcode\(0) & ( (!\inst2|opcode\(5) & 
...
-- Equation(s):
-- \inst7|Selector0~1_combout\ = ( \inst7|nextState.idle~q\ & ( \inst7|Selector0~0_combout\ & ( ((!\inst7|nextState.loadAluResult~q\ & (!\inst7|nextState.writeback~q\ & !\inst7|nextState.aluOperation~q\))) # (\inst7|increment\(3)) ) ) ) # ( 
-- \inst7|nextState.idle~q\ & ( !\inst7|Selector0~0_combout\ & ( ((!\inst7|nextState.loadAluResult~q\ & !\inst7|nextState.aluOperation~q\)) # (\inst7|increment\(3)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000110111010101010100000000000000001101010101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	dataf => \inst7|ALT_INV_Selector0~0_combout\,
...
-- Equation(s):
-- \inst7|Selector3~0_combout\ = ( \inst7|Selector0~0_combout\ & ( \inst7|nextState.fetch~q\ ) ) # ( !\inst7|Selector0~0_combout\ & ( \inst7|nextState.fetch~q\ ) ) # ( \inst7|Selector0~0_combout\ & ( !\inst7|nextState.fetch~q\ & ( (\inst7|increment\(0) & 
-- (((\inst7|nextState.aluOperation~q\) # (\inst7|nextState.writeback~q\)) # (\inst7|nextState.loadAluResult~q\))) ) ) ) # ( !\inst7|Selector0~0_combout\ & ( !\inst7|nextState.fetch~q\ & ( (\inst7|increment\(0) & ((\inst7|nextState.aluOperation~q\) # 
-- (\inst7|nextState.loadAluResult~q\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000101010101000101010101010111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst1|Mux1~0_combout\ = ((!\inst|out_count\(3) & ((\inst1|memory[0][14]~q\) # (\inst|out_count\(1)))) # (\inst|out_count\(3) & (!\inst|out_count\(1)))) # (\inst|out_count\(2))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111101111111011011110111111101101111011111110110111101111111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux0~0_combout\ = (!\inst|out_count\(3) & ((!\inst|out_count\(2) & (!\inst|out_count\(1) & \inst1|memory[0][15]~q\)) # (\inst|out_count\(2) & (\inst|out_count\(1)))))
...
PORT MAP (
	...
	datab => \inst|ALT_INV_out_count\(2),
	datac => \inst|ALT_INV_out_count\(1),
	datad => \inst1|ALT_INV_memory[0][15]~q\,
...
\inst7|Equal2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Equal2~0_combout\ = ( !\inst2|opcode\(0) & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(2) & !\inst2|opcode\(1)))) ) )
...
-- Equation(s):
-- \inst7|Selector14~0_combout\ = ( !\inst7|nextState.decode~q\ & ( ((((\inst7|rf_sel\(1))) # (\inst7|nextState.loadAluResult~q\))) ) ) # ( \inst7|nextState.decode~q\ & ( (!\inst7|Equal2~0_combout\ & ((((\inst7|rf_sel\(1)))))) # (\inst7|Equal2~0_combout\ & 
-- (((!\inst2|address_method\(0) & (!\inst2|address_method\(1) & \inst7|rf_sel\(1)))) # (\inst2|opcode\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0000111100001111000000000000111111111111111111111111100011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_address_method\(0),
	datab => \inst2|ALT_INV_address_method\(1),
	datac => \inst7|ALT_INV_Equal2~0_combout\,
...
-- Equation(s):
-- \inst7|Selector4~0_combout\ = ( \inst7|nextState.decode~q\ & ( \inst7|ld_r~q\ ) ) # ( !\inst7|nextState.decode~q\ & ( (\inst7|ld_r~q\ & (((\inst7|nextState.aluOperation~q\) # (\inst7|nextState.fetch2~q\)) # (\inst7|nextState.writeback~q\))) ) )
...
-- Equation(s):
-- \inst7|Selector4~1_combout\ = ( \inst7|Selector4~0_combout\ ) # ( !\inst7|Selector4~0_combout\ & ( ((!\inst2|opcode\(3) & (\inst7|Equal2~0_combout\ & \inst7|nextState.writeback~q\))) # (\inst7|nextState.loadAluResult~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100111011111111111111111100110011001110111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst7|ALT_INV_Selector4~0_combout\,
...
-- Equation(s):
-- \inst1|Mux11~0_combout\ = (((!\inst|out_count\(2) & \inst1|memory[0][4]~q\)) # (\inst|out_count\(1))) # (\inst|out_count\(3))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101111111011111010111111101111101011111110111110101111111011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
	datab => \inst|ALT_INV_out_count\(2),
	datac => \inst|ALT_INV_out_count\(1),
	datad => \inst1|ALT_INV_memory[0][4]~q\,
...
-- Equation(s):
-- \inst1|Mux10~0_combout\ = (!\inst|out_count\(1) & (((\inst1|memory[0][5]~q\) # (\inst|out_count\(2))) # (\inst|out_count\(3))))
...
PORT MAP (
	...
	datab => \inst|ALT_INV_out_count\(2),
	datac => \inst|ALT_INV_out_count\(1),
	datad => \inst1|ALT_INV_memory[0][5]~q\,
...
-- Equation(s):
-- \inst1|Mux30~0_combout\ = (!\inst|out_count\(3) & (!\inst|out_count\(2) & \inst|out_count\(1)))
...
-- Equation(s):
-- \inst1|Mux31~0_combout\ = (!\inst|out_count\(3) & (!\inst|out_count\(2) $ (!\inst|out_count\(1))))
...
-- Equation(s):
-- \inst7|Selector12~0_combout\ = ( !\inst7|nextState.decode~q\ & ( (((!\inst7|nextState.loadAluResult~q\ & ((\inst7|rf_sel\(3)))))) ) ) # ( \inst7|nextState.decode~q\ & ( (!\inst7|Equal2~0_combout\ & ((((\inst7|rf_sel\(3)))))) # (\inst7|Equal2~0_combout\ & 
-- (!\inst2|opcode\(3) & (((!\inst2|address_method\(0) & \inst7|rf_sel\(3))) # (\inst2|address_method\(1))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0000000000000000000001010000000011110000111100001111110111110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst7|Selector15~0_combout\ = ( !\inst7|nextState.decode~q\ & ( ((((\inst7|rf_sel\(0))) # (\inst7|nextState.loadAluResult~q\))) ) ) # ( \inst7|nextState.decode~q\ & ( (!\inst7|Equal2~0_combout\ & ((((\inst7|rf_sel\(0)))))) # (\inst7|Equal2~0_combout\ & 
-- (((!\inst2|address_method\(0) & ((\inst7|rf_sel\(0)) # (\inst2|address_method\(1))))) # (\inst2|opcode\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0000111100001111000001110000001111111111111111111111111111110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_address_method\(1),
...
-- Equation(s):
-- \inst1|Mux15~0_combout\ = (!\inst|out_count\(3) & (!\inst|out_count\(2) & (!\inst|out_count\(1) & \inst1|memory[0][0]~q\)))
...
-- Equation(s):
-- \inst1|Mux14~0_combout\ = (!\inst|out_count\(3) & ((!\inst|out_count\(2) & (!\inst|out_count\(1) & \inst1|memory[0][1]~q\)) # (\inst|out_count\(2) & (\inst|out_count\(1)))))
...
-- Equation(s):
-- \inst1|Mux13~1_combout\ = (!\inst|out_count\(3) & (!\inst|out_count\(2) & (!\inst|out_count\(1) & \inst1|memory[0][2]~q\)))
...
-- Equation(s):
-- \inst7|Selector7~0_combout\ = (\inst7|nextState.decode~q\ & ((!\inst7|Equal2~0_combout\) # (\inst2|opcode\(3))))
...
PORT MAP (
	dataa => \inst2|ALT_INV_opcode\(3),
	datab => \inst7|ALT_INV_Equal2~0_combout\,
	datac => \inst7|ALT_INV_nextState.decode~q\,
	combout => \inst7|Selector7~0_combout\);

\inst7|Selector11~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector11~0_combout\ = (\inst7|nextState.fetch~q\) # (\inst7|nextState.decode~q\)
...
PORT MAP (
	...
	ena => \inst7|Selector11~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst7|alu_opsel\(4));
...
-- Equation(s):
-- \inst7|Selector11~1_combout\ = ( \inst7|nextState.decode~q\ & ( (\inst7|Equal2~0_combout\ & ((!\inst2|opcode\(3)) # ((!\inst2|address_method\(0)) # (\inst2|address_method\(1))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001111101100000000000000000000000011111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_opcode\(3),
	...
	datad => \inst7|ALT_INV_Equal2~0_combout\,
	datae => \inst7|ALT_INV_nextState.decode~q\,
...
-- Equation(s):
-- \inst7|Selector9~0_combout\ = (\inst2|opcode\(3) & (!\inst2|address_method\(0) & (\inst7|Equal2~0_combout\ & \inst7|nextState.decode~q\)))
...
-- Equation(s):
-- \inst7|Selector10~0_combout\ = ( \inst7|nextState.decode~q\ & ( (\inst2|opcode\(3) & (\inst7|Equal2~0_combout\ & ((!\inst2|address_method\(1)) # (!\inst2|address_method\(0))))) ) )
...
-- Equation(s):
-- \inst9|Mux24~0_combout\ = (\inst7|alu_opsel\(4) & (!\inst7|alu_opsel\(2) & !\inst7|alu_opsel\(1)))
...
-- Equation(s):
-- \inst9|Mux4~0_combout\ = (\inst3|Mux36~4_combout\ & !\inst7|alu_opsel\(1))
...
\inst9|operand_2[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst9|operand_2[1]~1_combout\ = (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\)))
...
PORT MAP (
	...
	combout => \inst9|operand_2[1]~1_combout\);
...
-- Equation(s):
-- \inst9|Add0~37_sumout\ = SUM(( \inst9|operand_2[0]~0_combout\ ) + ( (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(1) & ((\inst3|Mux47~4_combout\))) # (\inst7|alu_opsel\(1) & (\inst2|operand\(0))))) # (\inst7|alu_opsel\(2) & (!\inst7|alu_opsel\(1))) ) + ( 
-- !VCC ))
-- \inst9|Add0~38\ = CARRY(( \inst9|operand_2[0]~0_combout\ ) + ( (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(1) & ((\inst3|Mux47~4_combout\))) # (\inst7|alu_opsel\(1) & (\inst2|operand\(0))))) # (\inst7|alu_opsel\(2) & (!\inst7|alu_opsel\(1))) ) + ( !VCC 
-- ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101110010011000100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \inst9|ALT_INV_operand_2[0]~0_combout\,
...
-- Equation(s):
-- \inst9|Mux31~0_combout\ = (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(1) & (\inst3|Mux47~4_combout\)) # (\inst7|alu_opsel\(1) & ((\inst2|operand\(0)))))) # (\inst7|alu_opsel\(2) & (((!\inst7|alu_opsel\(1)))))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111000001111100011100000111110001110000011111000111000001111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst3|ALT_INV_Mux47~4_combout\,
...
-- Equation(s):
-- \inst9|Mux31~1_combout\ = (!\inst7|alu_opsel\(4) & (((\inst9|Add0~37_sumout\)))) # (\inst7|alu_opsel\(4) & (\inst9|operand_2[0]~0_combout\ & ((\inst9|Mux31~0_combout\))))
...
PORT MAP (
	dataa => \inst7|ALT_INV_alu_opsel\(4),
	datab => \inst9|ALT_INV_operand_2[0]~0_combout\,
	datac => \inst9|ALT_INV_Add0~37_sumout\,
	datad => \inst9|ALT_INV_Mux31~0_combout\,
	combout => \inst9|Mux31~1_combout\);

\inst7|Selector8~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector8~0_combout\ = ( \inst2|opcode\(0) & ( \inst7|nextState.decode~q\ ) ) # ( !\inst2|opcode\(0) & ( \inst7|nextState.decode~q\ & ( (((\inst2|opcode\(1)) # (\inst2|opcode\(2))) # (\inst2|opcode\(4))) # (\inst2|opcode\(5)) ) ) )
...
\inst9|operand_2[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst9|operand_2[0]~0_combout\ = (!\inst7|alu_opsel\(0) & (\inst3|Mux47~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux63~4_combout\)))
...
PORT MAP (
	...
	datac => \inst7|ALT_INV_alu_opsel\(0),
	combout => \inst9|operand_2[0]~0_combout\);

\inst9|Add0~61\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst9|Add0~61_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(1) & ((\inst3|Mux46~4_combout\))) # (\inst7|alu_opsel\(1) & (\inst2|operand\(1))))) ) + ( \inst9|operand_2[1]~1_combout\ ) + ( \inst9|Add0~38\ ))
-- \inst9|Add0~62\ = CARRY(( (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(1) & ((\inst3|Mux46~4_combout\))) # (\inst7|alu_opsel\(1) & (\inst2|operand\(1))))) ) + ( \inst9|operand_2[1]~1_combout\ ) + ( \inst9|Add0~38\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000000000001010001010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_alu_opsel\(2),
	...
	dataf => \inst9|ALT_INV_operand_2[1]~1_combout\,
	cin => \inst9|Add0~38\,
...
-- Equation(s):
-- \inst9|Mux30~0_combout\ = (!\inst7|alu_opsel\(1) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(1) & ((\inst2|operand\(1))))
...
-- Equation(s):
-- \inst9|Mux30~1_combout\ = ( \inst9|Mux30~0_combout\ & ( (!\inst7|alu_opsel\(4) & (((\inst9|Add0~61_sumout\)))) # (\inst7|alu_opsel\(4) & (!\inst7|alu_opsel\(2) & (\inst9|operand_2[1]~1_combout\))) ) ) # ( !\inst9|Mux30~0_combout\ & ( 
-- (!\inst7|alu_opsel\(4) & \inst9|Add0~61_sumout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010101010000001001010111000000000101010100000010010101110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_alu_opsel\(4),
	datab => \inst7|ALT_INV_alu_opsel\(2),
	datac => \inst9|ALT_INV_operand_2[1]~1_combout\,
	datad => \inst9|ALT_INV_Add0~61_sumout\,
	datae => \inst9|ALT_INV_Mux30~0_combout\,
...
-- Equation(s):
-- \inst9|Add0~57_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & \inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~62\ ))
-- \inst9|Add0~58\ = CARRY(( (!\inst7|alu_opsel\(2) & \inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~62\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100111100000000000000000000000000000010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_alu_opsel\(2),
...
-- Equation(s):
-- \inst9|Mux29~1_combout\ = ( \inst9|Mux29~0_combout\ & ( (!\inst7|alu_opsel\(4) & (((\inst9|Add0~57_sumout\)))) # (\inst7|alu_opsel\(4) & (!\inst7|alu_opsel\(2) & (\inst9|Mux13~0_combout\))) ) ) # ( !\inst9|Mux29~0_combout\ & ( (!\inst7|alu_opsel\(4) & 
-- \inst9|Add0~57_sumout\) ) )
...
PORT MAP (
	...
	datad => \inst9|ALT_INV_Add0~57_sumout\,
	datae => \inst9|ALT_INV_Mux29~0_combout\,
...
-- Equation(s):
-- \inst9|Add0~53_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux44~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~58\ ))
-- \inst9|Add0~54\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux44~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~58\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100111100000000000000000000000000101000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_alu_opsel\(2),
...
-- Equation(s):
-- \inst9|Mux28~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~53_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux44~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux60~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~53_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~53_sumout\ & ( (\inst3|Mux44~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux60~4_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010101010001000111110000111100001111010111110001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \inst9|ALT_INV_Mux24~0_combout\,
...
-- Equation(s):
-- \inst9|Add0~41_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & \inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~54\ ))
-- \inst9|Add0~42\ = CARRY(( (!\inst7|alu_opsel\(2) & \inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~54\ ))
...
-- Equation(s):
-- \inst9|Mux27~0_combout\ = ( !\inst7|alu_opsel\(4) & ( (((\inst9|Add0~41_sumout\))) ) ) # ( \inst7|alu_opsel\(4) & ( (!\inst7|alu_opsel\(1) & (\inst3|Mux43~4_combout\ & (!\inst7|alu_opsel\(2) & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux59~4_combout\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0000111100001111000000001100010000001111000011110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datag => \inst9|ALT_INV_Add0~41_sumout\,
...
-- Equation(s):
-- \inst3|Mux27~8_combout\ = ( !\inst7|rf_sel\(0) & ( (!\inst7|rf_sel\(1) & (\inst7|rf_sel\(3) & (\inst3|Mux43~4_combout\))) # (\inst7|rf_sel\(1) & ((!\inst7|rf_sel\(3) & (((\inst9|alu_result\(4))))) # (\inst7|rf_sel\(3) & (((\inst3|Mux59~4_combout\)))))) ) 
-- ) # ( \inst7|rf_sel\(0) & ( (!\inst7|rf_sel\(1) & (\inst7|rf_sel\(3) & (\inst3|Mux27~0_combout\))) # (\inst7|rf_sel\(1) & ((!\inst7|rf_sel\(3) & (((\inst9|alu_result\(4))))) # (\inst7|rf_sel\(3) & (((\inst3|Mux59~4_combout\)))))) ) )
...
PORT MAP (
	...
	datae => \inst7|ALT_INV_rf_sel\(0),
	dataf => \inst9|ALT_INV_alu_result\(4),
...
-- Equation(s):
-- \inst9|Add0~45_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux42~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~42\ ))
-- \inst9|Add0~46\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux42~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~42\ ))
...
-- Equation(s):
-- \inst9|Mux26~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~45_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux42~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux58~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~45_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~45_sumout\ & ( (\inst3|Mux42~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux58~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~5_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux41~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux41~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux57~4_combout\))) ) + ( \inst9|Add0~46\ ))
-- \inst9|Add0~6\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux41~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux41~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux57~4_combout\))) ) + ( \inst9|Add0~46\ ))
...
-- Equation(s):
-- \inst9|Mux25~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~5_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux41~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux57~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~5_sumout\ & 
-- ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~5_sumout\ & ( (\inst3|Mux41~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux57~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~9_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux40~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~6\ ))
-- \inst9|Add0~10\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux40~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~6\ ))
...
-- Equation(s):
-- \inst9|Mux24~1_combout\ = ( \inst9|Add0~9_sumout\ & ( \inst9|Mux24~0_combout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux40~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux56~4_combout\)))) ) ) ) # ( !\inst9|Add0~9_sumout\ & ( \inst9|Mux24~0_combout\ & 
-- ( (\inst3|Mux40~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux56~4_combout\))) ) ) ) # ( \inst9|Add0~9_sumout\ & ( !\inst9|Mux24~0_combout\ & ( !\inst7|alu_opsel\(4) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100001111000001010101000100011111010111110001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst9|Add0~13_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux39~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~10\ ))
-- \inst9|Add0~14\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux39~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~10\ ))
...
-- Equation(s):
-- \inst9|Mux23~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~13_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux39~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux55~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~13_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~13_sumout\ & ( (\inst3|Mux39~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux55~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~17_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux38~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~14\ ))
-- \inst9|Add0~18\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux38~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~14\ ))
...
-- Equation(s):
-- \inst9|Mux22~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~17_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux38~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux54~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~17_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~17_sumout\ & ( (\inst3|Mux38~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux54~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~21_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux37~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~18\ ))
-- \inst9|Add0~22\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux37~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~18\ ))
...
-- Equation(s):
-- \inst9|Mux21~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~21_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux37~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux53~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~21_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~21_sumout\ & ( (\inst3|Mux37~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux53~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~25_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & \inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~22\ ))
-- \inst9|Add0~26\ = CARRY(( (!\inst7|alu_opsel\(2) & \inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~22\ ))
...
-- Equation(s):
-- \inst9|Mux20~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~25_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux36~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux52~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~25_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~25_sumout\ & ( (\inst3|Mux36~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux52~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~49_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux35~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~26\ ))
-- \inst9|Add0~50\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux35~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~26\ ))
...
-- Equation(s):
-- \inst9|Mux19~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~49_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux35~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux51~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~49_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~49_sumout\ & ( (\inst3|Mux35~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux51~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Add0~1_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux34~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~50\ ))
-- \inst9|Add0~2\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux34~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~50\ ))
...
-- Equation(s):
-- \inst9|Mux18~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~1_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux34~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux50~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~1_sumout\ & 
-- ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~1_sumout\ & ( (\inst3|Mux34~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux50~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Equal0~0_combout\ = ( !\inst9|result\(11) & ( (!\inst9|result\(7) & (!\inst9|result\(8) & (!\inst9|result\(9) & !\inst9|result\(10)))) ) )
...
-- Equation(s):
-- \inst9|Add0~29_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & (\inst3|Mux33~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~2\ ))
-- \inst9|Add0~30\ = CARRY(( (!\inst7|alu_opsel\(2) & (\inst3|Mux33~4_combout\ & !\inst7|alu_opsel\(1))) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~2\ ))
...
-- Equation(s):
-- \inst9|Mux17~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~29_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux33~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux49~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~29_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~29_sumout\ & ( (\inst3|Mux33~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux49~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Mux0~0_combout\ = (\inst3|Mux32~4_combout\ & !\inst7|alu_opsel\(1))
...
-- Equation(s):
-- \inst9|Add0~33_sumout\ = SUM(( (!\inst7|alu_opsel\(2) & \inst9|Mux0~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux32~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux48~4_combout\))) ) + ( \inst9|Add0~30\ ))
...
-- Equation(s):
-- \inst9|Mux16~0_combout\ = ( \inst9|Mux24~0_combout\ & ( \inst9|Add0~33_sumout\ & ( (!\inst7|alu_opsel\(4)) # ((\inst3|Mux32~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux48~4_combout\)))) ) ) ) # ( !\inst9|Mux24~0_combout\ & ( \inst9|Add0~33_sumout\ 
-- & ( !\inst7|alu_opsel\(4) ) ) ) # ( \inst9|Mux24~0_combout\ & ( !\inst9|Add0~33_sumout\ & ( (\inst3|Mux32~4_combout\ & ((!\inst7|alu_opsel\(0)) # (\inst3|Mux48~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst9|Equal0~1_combout\ = ( !\inst9|result\(5) & ( (!\inst9|result\(14) & (!\inst9|result\(15) & (!\inst9|result\(0) & !\inst9|result\(4)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~2_combout\ = (!\inst9|result\(12) & (!\inst9|result\(3) & (!\inst9|result\(2) & !\inst9|result\(1))))
...
-- Equation(s):
-- \inst9|Equal0~3_combout\ = ( \inst9|Equal0~2_combout\ & ( (!\inst9|result\(13) & (!\inst9|result\(6) & (\inst9|Equal0~0_combout\ & \inst9|Equal0~1_combout\))) ) )
