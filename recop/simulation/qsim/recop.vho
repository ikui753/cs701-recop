...
-- Equation(s):
-- \inst7|Mux49~0_combout\ = (!\inst2|opcode\(1) & !\inst2|opcode\(0))
...
-- Equation(s):
-- \inst1|Mux5~0_combout\ = ( \inst1|memory[0][10]~q\ & ( (!\inst|out_count\(0) & ((!\inst|out_count\(3) & (!\inst|out_count\(2) $ (\inst|out_count\(1)))) # (\inst|out_count\(3) & ((\inst|out_count\(1)) # (\inst|out_count\(2)))))) ) ) # ( 
-- !\inst1|memory[0][10]~q\ & ( (!\inst|out_count\(0) & ((!\inst|out_count\(3) & (\inst|out_count\(2) & \inst|out_count\(1))) # (\inst|out_count\(3) & ((\inst|out_count\(1)) # (\inst|out_count\(2)))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001011100000000100101110000000000010111000000001001011100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux0~0_combout\ = ( \inst1|memory[0][15]~q\ & ( (!\inst|out_count\(2) & (!\inst|out_count\(0) & ((!\inst|out_count\(1)) # (\inst|out_count\(3))))) ) ) # ( !\inst1|memory[0][15]~q\ & ( (\inst|out_count\(3) & (!\inst|out_count\(2) & 
-- !\inst|out_count\(0))) ) )
...
-- Equation(s):
-- \inst7|Selector11~0_combout\ = ( \inst7|dataSel~0_combout\ & ( \inst7|nextState~14_combout\ & ( \inst7|nextState.decode2~q\ ) ) ) # ( !\inst7|dataSel~0_combout\ & ( \inst7|nextState~14_combout\ & ( ((!\inst7|Mux49~0_combout\ & (!\inst7|Equal4~0_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_Mux49~0_combout\,
...
-- Equation(s):
-- \inst1|Mux10~0_combout\ = ( \inst1|memory[0][5]~q\ & ( (!\inst|out_count\(0) & ((!\inst|out_count\(3) & ((!\inst|out_count\(1)))) # (\inst|out_count\(3) & (!\inst|out_count\(2) & \inst|out_count\(1))))) ) ) # ( !\inst1|memory[0][5]~q\ & ( 
...
-- Equation(s):
-- \inst1|Mux13~0_combout\ = ( \inst|out_count\(0) & ( !\inst|out_count\(2) $ (((!\inst|out_count\(3)) # (!\inst|out_count\(1)))) ) ) # ( !\inst|out_count\(0) & ( (!\inst|out_count\(3) & (\inst1|memory[0][2]~q\ & (!\inst|out_count\(1) & 
-- !\inst|out_count\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000000000000001011111101000100000000000000000010111111010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
	datab => \inst1|ALT_INV_memory[0][2]~q\,
	datac => \inst|ALT_INV_out_count\(1),
	datad => \inst|ALT_INV_out_count\(2),
	datae => \inst|ALT_INV_out_count\(0),
...
-- Equation(s):
-- \inst1|Mux12~0_combout\ = ( \inst1|memory[0][3]~q\ & ( (!\inst|out_count\(3) & (!\inst|out_count\(2) & (!\inst|out_count\(1) & !\inst|out_count\(0)))) ) )
...
-- Equation(s):
-- \inst1|Mux15~0_combout\ = ( \inst1|memory[0][0]~q\ & ( (!\inst|out_count\(1) & (!\inst|out_count\(3) & ((!\inst|out_count\(0)) # (\inst|out_count\(2))))) # (\inst|out_count\(1) & (((!\inst|out_count\(2) & \inst|out_count\(0))))) ) ) # ( 
-- !\inst1|memory[0][0]~q\ & ( (!\inst|out_count\(2) & (((\inst|out_count\(1) & \inst|out_count\(0))))) # (\inst|out_count\(2) & (!\inst|out_count\(3) & (!\inst|out_count\(1)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000101100101000000010110000100000001011001010000000101100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux14~0_combout\ = ( \inst1|memory[0][1]~q\ & ( (!\inst|out_count\(0) & (!\inst|out_count\(2) $ ((\inst|out_count\(1))))) # (\inst|out_count\(0) & (\inst|out_count\(3) & ((!\inst|out_count\(2)) # (!\inst|out_count\(1))))) ) ) # ( 
-- !\inst1|memory[0][1]~q\ & ( (!\inst|out_count\(2) & (\inst|out_count\(3) & ((!\inst|out_count\(1)) # (\inst|out_count\(0))))) # (\inst|out_count\(2) & ((!\inst|out_count\(1) & (\inst|out_count\(0) & \inst|out_count\(3))) # (\inst|out_count\(1) & 
-- (!\inst|out_count\(0))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000010011110100100001001111000010000100111101001000010011110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst1|Mux29~0_combout\ = ( \inst|out_count\(0) & ( (\inst|out_count\(3) & (\inst|out_count\(2) & (\inst|out_count\(1) & \inst1|memory[0][2]~q\))) ) ) # ( !\inst|out_count\(0) & ( !\inst|out_count\(2) $ (((!\inst|out_count\(3)) # (!\inst|out_count\(1)))) 
-- ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011011000110110000000000000000100110110001101100000000000000001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux28~0_combout\ = ( \inst1|memory[0][3]~q\ & ( (\inst|out_count\(3) & (\inst|out_count\(2) & (\inst|out_count\(1) & \inst|out_count\(0)))) ) )
...
-- Equation(s):
-- \inst1|Mux31~0_combout\ = ( \inst1|memory[0][0]~q\ & ( (!\inst|out_count\(1) & (!\inst|out_count\(3) & (\inst|out_count\(2) & !\inst|out_count\(0)))) # (\inst|out_count\(1) & (!\inst|out_count\(2) $ (((\inst|out_count\(3) & \inst|out_count\(0)))))) ) ) # 
-- ( !\inst1|memory[0][0]~q\ & ( (!\inst|out_count\(2) & (\inst|out_count\(1) & ((!\inst|out_count\(3)) # (!\inst|out_count\(0))))) # (\inst|out_count\(2) & (!\inst|out_count\(3) & (!\inst|out_count\(1) & !\inst|out_count\(0)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010110000001000001011000000100100101100000010000010110000001001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux30~0_combout\ = ( \inst1|memory[0][1]~q\ & ( (!\inst|out_count\(0) & (\inst|out_count\(3) & ((!\inst|out_count\(1)) # (!\inst|out_count\(2))))) # (\inst|out_count\(0) & (((\inst|out_count\(2))))) ) ) # ( !\inst1|memory[0][1]~q\ & ( 
-- (!\inst|out_count\(2) & (((\inst|out_count\(3) & !\inst|out_count\(0))))) # (\inst|out_count\(2) & ((!\inst|out_count\(3) & ((\inst|out_count\(0)))) # (\inst|out_count\(3) & (!\inst|out_count\(1))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111000110010000011100011001100001110001100100000111000110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(1),
	datab => \inst|ALT_INV_out_count\(2),
	datac => \inst|ALT_INV_out_count\(3),
	datad => \inst|ALT_INV_out_count\(0),
	datae => \inst1|ALT_INV_memory[0][1]~q\,
...
-- Equation(s):
-- \inst7|Mux50~4_combout\ = ( \inst7|Mux50~0_combout\ & ( \inst7|Mux50~3_combout\ & ( (!\inst2|opcode\(4) & (!\inst2|opcode\(5))) # (\inst2|opcode\(4) & (((\inst7|alu_opsel\(3) & \inst7|Mux49~0_combout\)))) ) ) ) # ( !\inst7|Mux50~0_combout\ & ( 
-- \inst7|Mux50~3_combout\ & ( (!\inst2|opcode\(5) & !\inst2|opcode\(4)) ) ) ) # ( \inst7|Mux50~0_combout\ & ( !\inst7|Mux50~3_combout\ & ( (\inst2|opcode\(4) & (\inst7|alu_opsel\(3) & \inst7|Mux49~0_combout\)) ) ) )
...
-- Equation(s):
-- \inst9|Add0~1_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~46\ ))
-- \inst9|Add0~2\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~46\ ))
...
-- Equation(s):
-- \inst9|Add0~37_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~2\ ))
-- \inst9|Add0~38\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~2\ ))
...
-- Equation(s):
-- \inst9|Mux29~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~37_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux13~0_combout\ & (\inst3|Mux45~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux13~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux45~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~37_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux13~0_combout\ & (\inst3|Mux61~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~61_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~38\ ))
-- \inst9|Add0~62\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~38\ ))
...
-- Equation(s):
-- \inst9|Add0~53_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~62\ ))
-- \inst9|Add0~54\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~62\ ))
...
-- Equation(s):
-- \inst9|Mux27~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux11~0_combout\ & (\inst3|Mux43~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux11~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux43~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux11~0_combout\ & (\inst3|Mux59~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst1|Mux16~0_combout\ = ( \inst1|memory[0][15]~q\ & ( (\inst|out_count\(0) & ((!\inst|out_count\(2) & (\inst|out_count\(3) & !\inst|out_count\(1))) # (\inst|out_count\(2) & ((\inst|out_count\(1)))))) ) ) # ( !\inst1|memory[0][15]~q\ & ( 
-- (\inst|out_count\(0) & ((!\inst|out_count\(3) & (\inst|out_count\(2) & \inst|out_count\(1))) # (\inst|out_count\(3) & (!\inst|out_count\(2) & !\inst|out_count\(1))))) ) )
...
-- Equation(s):
-- \inst1|Mux19~0_combout\ = ( \inst1|memory[0][12]~q\ & ( (\inst|out_count\(3) & (\inst|out_count\(0) & ((!\inst|out_count\(2)) # (\inst|out_count\(1))))) ) ) # ( !\inst1|memory[0][12]~q\ & ( (\inst|out_count\(3) & (!\inst|out_count\(2) & 
-- \inst|out_count\(0))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001000100000000000100010100000000010001000000000001000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux21~0_combout\ = ( \inst1|memory[0][10]~q\ & ( (\inst|out_count\(0) & (((\inst|out_count\(2) & !\inst|out_count\(1))) # (\inst|out_count\(3)))) ) ) # ( !\inst1|memory[0][10]~q\ & ( (\inst|out_count\(0) & ((!\inst|out_count\(2) & 
-- (\inst|out_count\(3))) # (\inst|out_count\(2) & ((!\inst|out_count\(1)))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001110100000000000111010100000000011101000000000001110101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst9|Add0~13_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~54\ ))
-- \inst9|Add0~14\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~54\ ))
...
-- Equation(s):
-- \inst9|Add0~25_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux8~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~18\ ))
-- \inst9|Add0~26\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux8~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~18\ ))
...
-- Equation(s):
-- \inst9|Mux24~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~25_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux8~0_combout\ & (\inst3|Mux40~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux8~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux40~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~25_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux8~0_combout\ & (\inst3|Mux56~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~29_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~26\ ))
-- \inst9|Add0~30\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~26\ ))
...
-- Equation(s):
-- \inst9|Add0~21_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~30\ ))
-- \inst9|Add0~22\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~30\ ))
...
-- Equation(s):
-- \inst9|Add0~33_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~22\ ))
-- \inst9|Add0~34\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~22\ ))
...
-- Equation(s):
-- \inst9|Mux21~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux5~0_combout\ & (\inst3|Mux37~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux5~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux37~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux5~0_combout\ & (\inst3|Mux53~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~41_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~34\ ))
-- \inst9|Add0~42\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~34\ ))
...
-- Equation(s):
-- \inst9|Mux20~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~41_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux36~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux4~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux36~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~41_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux52~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~9_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~42\ ))
-- \inst9|Add0~10\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~42\ ))
...
-- Equation(s):
-- \inst9|Mux19~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~9_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux3~0_combout\ & (\inst3|Mux35~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux3~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux35~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~9_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux3~0_combout\ & (\inst3|Mux51~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~49_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~10\ ))
-- \inst9|Add0~50\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~10\ ))
...
-- Equation(s):
-- \inst9|Mux18~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux2~0_combout\ & (\inst3|Mux34~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux2~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux34~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux2~0_combout\ & (\inst3|Mux50~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~57_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~50\ ))
-- \inst9|Add0~58\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~50\ ))
...
-- Equation(s):
-- \inst9|Add0~5_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux0~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux32~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux48~4_combout\))) ) + ( \inst9|Add0~58\ ))
...
-- Equation(s):
-- \inst6|process_0~0_combout\ = ( !\inst3|Mux52~4_combout\ & ( !\inst3|Mux53~4_combout\ & ( (!\inst3|Mux48~4_combout\ & (!\inst3|Mux49~4_combout\ & (!\inst3|Mux50~4_combout\ & !\inst3|Mux51~4_combout\))) ) ) )
...
-- Equation(s):
-- \inst6|process_0~3_combout\ = ( \inst6|process_0~1_combout\ & ( \inst6|process_0~2_combout\ & ( (!\inst3|Mux59~4_combout\ & (\inst3|Mux63~4_combout\ & (\inst7|Equal3~0_combout\ & \inst6|process_0~0_combout\))) ) ) )
...
PORT MAP (
	...
	datad => \inst6|ALT_INV_process_0~0_combout\,
	datae => \inst6|ALT_INV_process_0~1_combout\,
	dataf => \inst6|ALT_INV_process_0~2_combout\,
...
-- Equation(s):
-- \inst6|process_0~4_combout\ = ( \inst6|process_0~1_combout\ & ( \inst6|process_0~2_combout\ & ( (!\inst3|Mux59~4_combout\ & (!\inst3|Mux63~4_combout\ & (\inst7|Equal5~0_combout\ & \inst6|process_0~0_combout\))) ) ) )
...
-- Equation(s):
-- \inst1|Mux3~0_combout\ = ( \inst1|memory[0][12]~q\ & ( (!\inst|out_count\(0) & ((!\inst|out_count\(3) & (!\inst|out_count\(2) & !\inst|out_count\(1))) # (\inst|out_count\(3) & (!\inst|out_count\(2) $ (!\inst|out_count\(1)))))) ) ) # ( 
-- !\inst1|memory[0][12]~q\ & ( (\inst|out_count\(3) & (!\inst|out_count\(0) & (!\inst|out_count\(2) $ (!\inst|out_count\(1))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001010000000000100101000000000000010100000000001001010000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst9|Mux30~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux14~0_combout\ & (\inst3|Mux46~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux14~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux46~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux14~0_combout\ & (\inst3|Mux62~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Equal0~0_combout\ = ( !\inst9|result\(7) & ( (!\inst9|result\(12) & (!\inst9|result\(5) & (!\inst9|result\(6) & !\inst9|result\(9)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~1_combout\ = ( !\inst9|result\(0) & ( (!\inst9|result\(8) & (!\inst9|result\(10) & (!\inst9|result\(2) & !\inst9|result\(11)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~2_combout\ = (!\inst9|result\(13) & (!\inst9|result\(4) & (!\inst9|result\(14) & !\inst9|result\(3))))
...
-- Equation(s):
-- \inst9|Equal0~3_combout\ = ( \inst9|Equal0~2_combout\ & ( (!\inst9|result\(1) & (!\inst9|result\(15) & (\inst9|Equal0~0_combout\ & \inst9|Equal0~1_combout\))) ) )
