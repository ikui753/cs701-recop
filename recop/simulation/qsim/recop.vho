...
SIGNAL \inst7|ALT_INV_Selector6~3_combout\ : std_logic;
...
SIGNAL \inst7|ALT_INV_Selector1~2_combout\ : std_logic;
...
\inst7|ALT_INV_Selector6~3_combout\ <= NOT \inst7|Selector6~3_combout\;
...
\inst7|ALT_INV_Selector1~2_combout\ <= NOT \inst7|Selector1~2_combout\;
...
-- Equation(s):
-- \inst7|Selector8~1_combout\ = ( \inst7|Selector8~0_combout\ & ( (!\inst7|nextState.decode3~q\ & (((\inst7|Equal6~0_combout\ & \inst7|nextState.selStore~q\)))) # (\inst7|nextState.decode3~q\ & (((\inst7|Equal6~0_combout\ & \inst7|nextState.selStore~q\)) # 
-- (\inst7|Equal0~0_combout\))) ) ) # ( !\inst7|Selector8~0_combout\ )
...
-- Equation(s):
-- \inst7|dataSel~1_combout\ = ( \inst2|opcode\(1) & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & !\inst2|opcode\(2)))) ) )
...
-- Equation(s):
-- \inst7|Selector12~0_combout\ = ( \inst7|Equal0~0_combout\ & ( \inst7|nextState~15_combout\ & ( \inst7|nextState.decode2~q\ ) ) ) # ( !\inst7|Equal0~0_combout\ & ( \inst7|nextState~15_combout\ & ( ((\inst7|nextState.decode3~q\ & (!\inst7|dataSel~1_combout\ 
-- & !\inst7|nextState~14_combout\))) # (\inst7|nextState.decode2~q\) ) ) ) # ( \inst7|Equal0~0_combout\ & ( !\inst7|nextState~15_combout\ & ( \inst7|nextState.decode2~q\ ) ) ) # ( !\inst7|Equal0~0_combout\ & ( !\inst7|nextState~15_combout\ & ( 
-- ((\inst7|nextState.decode3~q\ & !\inst7|dataSel~1_combout\)) # (\inst7|nextState.decode2~q\) ) ) )
...
-- Equation(s):
-- \inst7|nextState~17_combout\ = ( !\inst7|Equal0~0_combout\ & ( (!\inst2|opcode\(0) & (\inst7|nextState.decode3~q\ & \inst7|dataSel~1_combout\)) ) )
...
-- Equation(s):
-- \inst7|Selector0~0_combout\ = ( \inst7|nextState.fetch~q\ & ( \inst7|WideOr1~combout\ & ( (!\inst7|Equal0~0_combout\ & ((!\inst7|nextState.decode3~q\) # (!\inst7|Equal6~0_combout\))) ) ) ) # ( !\inst7|nextState.fetch~q\ & ( \inst7|WideOr1~combout\ & ( 
-- (!\inst7|nextState.decode3~q\) # ((!\inst7|Equal0~0_combout\ & ((!\inst7|Equal6~0_combout\))) # (\inst7|Equal0~0_combout\ & (\inst2|address_method\(0)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011111101110011011111000011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst7|Selector0~1_combout\ = (\inst7|nextState.idle~q\ & ((\inst7|Selector0~0_combout\) # (\inst7|increment\(3))))
...
-- Equation(s):
-- \inst7|Selector19~0_combout\ = ( \inst2|opcode\(1) & ( \inst2|address_method\(0) & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & !\inst2|opcode\(2)))) ) ) ) # ( !\inst2|opcode\(1) & ( \inst2|address_method\(0) & ( (!\inst2|opcode\(5) 
...
-- Equation(s):
-- \inst7|Selector19~1_combout\ = ( \inst7|Mux51~0_combout\ & ( \inst7|Selector19~0_combout\ & ( (!\inst7|nextState.decode3~q\ & (\inst7|nextState.fetch~q\)) # (\inst7|nextState.decode3~q\ & (((\inst7|Mux47~4_combout\) # (\inst7|Mux0~0_combout\)))) ) ) ) # ( 
-- !\inst7|Mux51~0_combout\ & ( \inst7|Selector19~0_combout\ & ( (!\inst7|nextState.decode3~q\ & (\inst7|nextState.fetch~q\)) # (\inst7|nextState.decode3~q\ & ((\inst7|Mux47~4_combout\))) ) ) ) # ( \inst7|Mux51~0_combout\ & ( !\inst7|Selector19~0_combout\ & 
-- ( (\inst7|nextState.fetch~q\) # (\inst7|nextState.decode3~q\) ) ) ) # ( !\inst7|Mux51~0_combout\ & ( !\inst7|Selector19~0_combout\ & ( (\inst7|nextState.fetch~q\) # (\inst7|nextState.decode3~q\) ) ) )
...
PORT MAP (
	...
	sclr => \inst7|ALT_INV_nextState.decode3~q\,
	ena => \inst7|Selector19~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst7|alu_opsel\(5));
...
-- Equation(s):
-- \inst9|Mux31~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux15~0_combout\ & (\inst3|Mux47~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux15~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux47~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux15~0_combout\ & (\inst3|Mux63~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~21_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~34\ ))
-- \inst9|Add0~22\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~34\ ))
...
-- Equation(s):
-- \inst7|Selector1~0_combout\ = (\inst7|Equal6~0_combout\ & ((\inst7|nextState.selStore~q\) # (\inst7|nextState.fetch~q\)))
...
-- Equation(s):
-- \inst7|Selector3~0_combout\ = ( \inst7|Equal0~0_combout\ & ( \inst7|Equal6~0_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|address_method\(0) & (\inst7|increment\(0))) # (\inst2|address_method\(0) & ((!\inst2|address_method\(1)))))) ) ) ) # ( 
-- !\inst7|Equal0~0_combout\ & ( \inst7|Equal6~0_combout\ & ( (\inst7|increment\(0) & \inst7|nextState.decode3~q\) ) ) ) # ( \inst7|Equal0~0_combout\ & ( !\inst7|Equal6~0_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|address_method\(0) & 
-- (\inst7|increment\(0))) # (\inst2|address_method\(0) & ((!\inst2|address_method\(1)))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000101110000000000010101010000000001011100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_increment\(0),
	...
	datae => \inst7|ALT_INV_Equal0~0_combout\,
	dataf => \inst7|ALT_INV_Equal6~0_combout\,
	combout => \inst7|Selector3~0_combout\);

\inst7|Selector3~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector3~1_combout\ = ( \inst7|WideOr1~combout\ & ( (!\inst7|Equal6~0_combout\ & (\inst7|nextState.fetch~q\ & ((!\inst7|Equal0~0_combout\) # (\inst7|increment\(0))))) ) ) # ( !\inst7|WideOr1~combout\ & ( ((!\inst7|Equal0~0_combout\ & 
-- (!\inst7|Equal6~0_combout\ & \inst7|nextState.fetch~q\))) # (\inst7|increment\(0)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010111010101000000001101000001010101110101010000000011010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_increment\(0),
...
-- Equation(s):
-- \inst7|Selector3~2_combout\ = (((!\inst6|presentJmp~q\ & \inst7|Selector1~0_combout\)) # (\inst7|Selector3~1_combout\)) # (\inst7|Selector3~0_combout\)
...
PORT MAP (
	...
	datab => \inst7|ALT_INV_Selector1~0_combout\,
...
-- Equation(s):
-- \inst9|Add0~37_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~22\ ))
-- \inst9|Add0~38\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~22\ ))
...
-- Equation(s):
-- \inst7|nextState~16_combout\ = ( !\inst7|Equal0~0_combout\ & ( \inst7|nextState~15_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|opcode\(0) & (!\inst2|opcode\(1) & !\inst7|dataSel~1_combout\)) # (\inst2|opcode\(0) & 
-- ((\inst7|dataSel~1_combout\))))) ) ) ) # ( !\inst7|Equal0~0_combout\ & ( !\inst7|nextState~15_combout\ & ( (\inst2|opcode\(0) & (\inst7|nextState.decode3~q\ & \inst7|dataSel~1_combout\)) ) ) )
...
-- Equation(s):
-- \inst7|Selector6~0_combout\ = ( \inst7|nextState~14_combout\ & ( (!\inst2|opcode\(2) & (!\inst7|nextState.decode3~q\ & ((!\inst7|nextState.execution~q\)))) # (\inst2|opcode\(2) & (((!\inst7|nextState.decode3~q\ & !\inst7|nextState.execution~q\)) # 
-- (\inst7|Mux54~0_combout\))) ) ) # ( !\inst7|nextState~14_combout\ & ( (!\inst7|nextState.decode3~q\ & !\inst7|nextState.execution~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000110011010000010111001100000000001100110100000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_opcode\(2),
...
-- Equation(s):
-- \inst7|Selector6~1_combout\ = (!\inst7|nextState.storeData~q\ & (!\inst7|nextState.decode~q\ & (!\inst7|nextState.loadAluResult~q\ & !\inst7|nextState.selStore~q\)))
...
-- Equation(s):
-- \inst7|Selector6~2_combout\ = ( !\inst2|opcode\(1) & ( !\inst2|opcode\(0) & ( (!\inst2|opcode\(5) & ((!\inst2|opcode\(4) & (!\inst2|opcode\(3) & \inst2|opcode\(2))) # (\inst2|opcode\(4) & (\inst2|opcode\(3))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001010000010000000000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_opcode\(5),
...
-- Equation(s):
-- \inst7|Selector6~3_combout\ = (!\inst7|nextState.storeAluResult~q\ & ((!\inst7|nextState.execution~q\) # ((\inst7|Selector6~2_combout\) # (\inst7|OUTPUTS~0_combout\))))
...
\inst7|Selector6~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector6~4_combout\ = ( \inst7|Selector6~3_combout\ & ( (\inst7|ld_r~q\ & (((!\inst7|Selector6~0_combout\) # (!\inst7|Selector6~1_combout\)) # (\inst7|Selector14~0_combout\))) ) ) # ( !\inst7|Selector6~3_combout\ )
...
PORT MAP (
	...
	datae => \inst7|ALT_INV_Selector6~3_combout\,
...
-- Equation(s):
-- \inst9|Add0~41_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~38\ ))
-- \inst9|Add0~42\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~38\ ))
...
-- Equation(s):
-- \inst9|Mux28~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~41_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux12~0_combout\ & (\inst3|Mux44~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux12~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux44~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~41_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux12~0_combout\ & (\inst3|Mux60~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~17_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~42\ ))
-- \inst9|Add0~18\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~42\ ))
...
-- Equation(s):
-- \inst9|Add0~61_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~18\ ))
-- \inst9|Add0~62\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~18\ ))
...
-- Equation(s):
-- \inst9|Add0~49_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~46\ ))
-- \inst9|Add0~50\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~46\ ))
...
-- Equation(s):
-- \inst9|Mux23~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux7~0_combout\ & (\inst3|Mux39~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux7~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux39~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux7~0_combout\ & (\inst3|Mux55~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~53_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~50\ ))
-- \inst9|Add0~54\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~50\ ))
...
-- Equation(s):
-- \inst9|Mux22~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux6~0_combout\ & (\inst3|Mux38~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux6~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux38~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux6~0_combout\ & (\inst3|Mux54~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~57_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~54\ ))
-- \inst9|Add0~58\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~54\ ))
...
-- Equation(s):
-- \inst9|Mux21~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~57_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux5~0_combout\ & (\inst3|Mux37~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux5~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux37~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~57_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux5~0_combout\ & (\inst3|Mux53~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~9_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~58\ ))
-- \inst9|Add0~10\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~58\ ))
...
-- Equation(s):
-- \inst9|Mux20~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~9_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux36~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux4~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux36~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~9_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux52~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~13_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~10\ ))
-- \inst9|Add0~14\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~10\ ))
...
-- Equation(s):
-- \inst9|Add0~25_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~14\ ))
-- \inst9|Add0~26\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~14\ ))
...
-- Equation(s):
-- \inst9|Add0~29_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~26\ ))
-- \inst9|Add0~30\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~26\ ))
...
-- Equation(s):
-- \inst9|Mux17~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~29_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux1~0_combout\ & (\inst3|Mux33~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux1~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux33~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~29_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux1~0_combout\ & (\inst3|Mux49~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst7|Selector1~1_combout\ = ( \inst7|Equal6~0_combout\ & ( (\inst7|nextState.decode3~q\ & (((\inst2|address_method\(0) & \inst7|Equal0~0_combout\)) # (\inst7|increment\(2)))) ) ) # ( !\inst7|Equal6~0_combout\ & ( (\inst7|nextState.decode3~q\ & 
-- (\inst7|Equal0~0_combout\ & ((\inst2|address_method\(0)) # (\inst7|increment\(2))))) ) )
...
PORT MAP (
	...
	datae => \inst7|ALT_INV_Equal6~0_combout\,
	combout => \inst7|Selector1~1_combout\);

\inst7|Selector1~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector1~2_combout\ = (\inst7|WideOr1~combout\ & ((!\inst7|Equal0~0_combout\) # ((!\inst7|nextState.fetch~q\) # (\inst7|Equal6~0_combout\))))
...
\inst7|Selector1~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector1~3_combout\ = ( \inst7|Selector1~2_combout\ & ( ((\inst6|presentJmp~q\ & \inst7|Selector1~0_combout\)) # (\inst7|Selector1~1_combout\) ) ) # ( !\inst7|Selector1~2_combout\ & ( (((\inst6|presentJmp~q\ & \inst7|Selector1~0_combout\)) # 
-- (\inst7|Selector1~1_combout\)) # (\inst7|increment\(2)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011011111111111000001011111111100110111111111110000010111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst6|ALT_INV_presentJmp~q\,
	datab => \inst7|ALT_INV_increment\(2),
	datac => \inst7|ALT_INV_Selector1~0_combout\,
	datad => \inst7|ALT_INV_Selector1~1_combout\,
	datae => \inst7|ALT_INV_Selector1~2_combout\,
...
-- Equation(s):
-- \inst7|Selector19~2_combout\ = ( \inst7|Equal0~1_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|opcode\(5) $ (!\inst2|opcode\(4))) # (\inst2|opcode\(2)))) ) ) # ( !\inst7|Equal0~1_combout\ & ( \inst7|nextState.decode3~q\ ) )
...
-- Equation(s):
-- \inst9|Add0~1_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux0~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux32~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux48~4_combout\))) ) + ( \inst9|Add0~30\ ))
...
-- Equation(s):
-- \inst9|Mux16~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux0~0_combout\ & (\inst3|Mux32~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux0~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux32~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux0~0_combout\ & (\inst3|Mux48~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Equal0~0_combout\ = ( !\inst9|result\(13) & ( (!\inst9|result\(11) & (!\inst9|result\(12) & (!\inst9|result\(4) & !\inst9|result\(1)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~1_combout\ = ( !\inst9|result\(7) & ( (!\inst9|result\(14) & (!\inst9|result\(0) & (!\inst9|result\(2) & !\inst9|result\(3)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~2_combout\ = (!\inst9|result\(8) & (!\inst9|result\(9) & (!\inst9|result\(10) & !\inst9|result\(5))))
...
-- Equation(s):
-- \inst9|Equal0~3_combout\ = ( \inst9|Equal0~2_combout\ & ( (!\inst9|result\(15) & (!\inst9|result\(6) & (\inst9|Equal0~0_combout\ & \inst9|Equal0~1_combout\))) ) )
...
-- Equation(s):
-- \inst7|dataSel~2_combout\ = (!\inst2|opcode\(0) & (\inst7|nextState.decode3~q\ & (!\inst7|dataSel~0_combout\ & \inst7|dataSel~1_combout\)))
