...
SIGNAL \inst7|ALT_INV_WideOr8~0_combout\ : std_logic;
...
SIGNAL \inst7|ALT_INV_Selector6~2_combout\ : std_logic;
...
\inst7|ALT_INV_WideOr8~0_combout\ <= NOT \inst7|WideOr8~0_combout\;
...
\inst7|ALT_INV_Selector6~2_combout\ <= NOT \inst7|Selector6~2_combout\;
...
-- Equation(s):
-- \inst7|Selector5~0_combout\ = ( \inst7|Equal0~0_combout\ & ( ((\inst7|nextState.execution~q\) # (\inst7|nextState.decode2~q\)) # (\inst7|nextState.loadAluResult~q\) ) ) # ( !\inst7|Equal0~0_combout\ & ( (((\inst7|nextState.execution~q\) # 
...
-- Equation(s):
-- \inst7|WideOr7~combout\ = ( \inst7|nextState.fetch2~q\ ) # ( !\inst7|nextState.fetch2~q\ & ( (((\inst7|nextState.execution~q\) # (\inst7|nextState.loadAluResult~q\)) # (\inst7|nextState.decode~q\)) # (\inst7|nextState.storeData~q\) ) )
...
-- Equation(s):
-- \inst7|nextState~17_combout\ = (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & (!\inst2|opcode\(2) & \inst2|opcode\(1)))) # (\inst2|opcode\(4) & (\inst2|opcode\(3) & (\inst2|opcode\(2) & !\inst2|opcode\(1))))
...
-- Equation(s):
-- \inst7|nextState~18_combout\ = (!\inst2|opcode\(5) & (!\inst2|opcode\(0) & (\inst7|nextState.decode3~q\ & \inst7|nextState~17_combout\)))
...
\inst7|WideOr8~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|WideOr8~0_combout\ = (\inst7|nextState.fetch~q\) # (\inst7|nextState.decode3~q\)
...
\inst7|WideOr8\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|WideOr8~combout\ = (((\inst7|WideOr8~0_combout\) # (\inst7|nextState.selStore~q\)) # (\inst7|nextState.loadAluResult~q\)) # (\inst7|nextState.decode~q\)
...
PORT MAP (
	...
	datad => \inst7|ALT_INV_WideOr8~0_combout\,
...
-- Equation(s):
-- \inst7|Equal6~0_combout\ = (!\inst2|opcode\(5) & (\inst2|opcode\(4) & \inst2|opcode\(2)))
...
-- Equation(s):
-- \inst7|Selector13~0_combout\ = (\inst7|nextState.selStore~q\ & ((!\inst7|Equal0~1_combout\) # (!\inst7|Equal6~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_Equal0~1_combout\,
...
-- Equation(s):
-- \inst7|Selector4~0_combout\ = ( \inst7|nextState.selStore~q\ & ( (((!\inst7|Equal0~1_combout\) # (!\inst7|Equal6~0_combout\)) # (\inst7|nextState.storeData~q\)) # (\inst7|nextState.storeAluResult~q\) ) ) # ( !\inst7|nextState.selStore~q\ & ( 
-- (\inst7|nextState.storeData~q\) # (\inst7|nextState.storeAluResult~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011101110111111111111111011101110111011101111111111111110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \inst7|ALT_INV_Equal6~0_combout\,
...
-- Equation(s):
-- \inst7|Selector0~0_combout\ = (!\inst7|nextState.fetch~q\ & ((!\inst7|nextState.decode3~q\) # ((\inst2|address_method\(0) & \inst7|Equal0~0_combout\))))
...
-- Equation(s):
-- \inst7|WideOr1~combout\ = ( \inst7|nextState.decode2~q\ & ( \inst7|nextState.execution~q\ ) ) # ( !\inst7|nextState.decode2~q\ & ( \inst7|nextState.execution~q\ ) ) # ( \inst7|nextState.decode2~q\ & ( !\inst7|nextState.execution~q\ ) ) # ( 
-- !\inst7|nextState.decode2~q\ & ( !\inst7|nextState.execution~q\ & ( (((\inst7|nextState.loadAluResult~q\) # (\inst7|nextState.decode~q\)) # (\inst7|nextState.storeData~q\)) # (\inst7|nextState.storeAluResult~q\) ) ) )
...
-- Equation(s):
-- \inst7|Selector0~1_combout\ = ( \inst7|WideOr1~combout\ & ( (\inst7|increment\(3) & \inst7|nextState.idle~q\) ) ) # ( !\inst7|WideOr1~combout\ & ( (\inst7|nextState.idle~q\ & (((!\inst7|OUTPUTS~0_combout\) # (\inst7|Selector0~0_combout\)) # 
-- (\inst7|increment\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000100110011000100010001000100110001001100110001000100010001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst1|Mux31~0_combout\ = ( \inst1|memory[0][0]~q\ & ( (!\inst|out_count\(1) & (!\inst|out_count\(3) & (\inst|out_count\(2) & !\inst|out_count\(0)))) # (\inst|out_count\(1) & (\inst|out_count\(0) & (!\inst|out_count\(3) $ (\inst|out_count\(2))))) ) ) # ( 
-- !\inst1|memory[0][0]~q\ & ( (!\inst|out_count\(3) & ((!\inst|out_count\(2) & (\inst|out_count\(1) & \inst|out_count\(0))) # (\inst|out_count\(2) & (!\inst|out_count\(1) & !\inst|out_count\(0))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000001000001000000000100100100000000010000010000000001001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst1|Mux30~0_combout\ = ( \inst1|memory[0][1]~q\ & ( (!\inst|out_count\(3) & (((\inst|out_count\(2) & \inst|out_count\(0))))) # (\inst|out_count\(3) & (!\inst|out_count\(0) $ (((\inst|out_count\(1) & \inst|out_count\(2)))))) ) ) # ( 
-- !\inst1|memory[0][1]~q\ & ( (!\inst|out_count\(3) & (((\inst|out_count\(2) & \inst|out_count\(0))))) # (\inst|out_count\(3) & (!\inst|out_count\(0) & ((!\inst|out_count\(1)) # (!\inst|out_count\(2))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001000001100001100100000110100110010000011000011001000001101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(1),
	datab => \inst|ALT_INV_out_count\(3),
	datac => \inst|ALT_INV_out_count\(2),
	datad => \inst|ALT_INV_out_count\(0),
...
-- Equation(s):
-- \inst7|Mux50~2_combout\ = (!\inst2|opcode\(5) & (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & \inst7|alu_opsel\(3))))
...
-- Equation(s):
-- \inst7|Mux50~3_combout\ = (!\inst7|Equal0~1_combout\ & (((\inst7|Mux50~1_combout\ & \inst7|Mux50~2_combout\)))) # (\inst7|Equal0~1_combout\ & (((\inst7|Mux50~1_combout\ & \inst7|Mux50~2_combout\)) # (\inst7|Mux50~0_combout\)))
...
PORT MAP (
	dataa => \inst7|ALT_INV_Equal0~1_combout\,
	datab => \inst7|ALT_INV_Mux50~0_combout\,
	datac => \inst7|ALT_INV_Mux50~1_combout\,
	datad => \inst7|ALT_INV_Mux50~2_combout\,
...
PORT MAP (
	clk => \clkIn~input_o\,
	d => \inst7|Mux50~3_combout\,
	sclr => \inst7|ALT_INV_nextState.decode3~q\,
	ena => \inst7|WideOr8~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst7|alu_opsel\(3));
...
-- Equation(s):
-- \inst1|Mux15~0_combout\ = ( \inst1|memory[0][0]~q\ & ( (!\inst|out_count\(3) & (!\inst|out_count\(1) & ((!\inst|out_count\(0)) # (\inst|out_count\(2))))) ) ) # ( !\inst1|memory[0][0]~q\ & ( (!\inst|out_count\(3) & (\inst|out_count\(2) & 
-- !\inst|out_count\(1))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000100000101000000010000000100000001000001010000000100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst|ALT_INV_out_count\(3),
...
-- Equation(s):
-- \inst9|Add0~17_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~10\ ))
-- \inst9|Add0~18\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux14~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux46~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux62~4_combout\))) ) + ( \inst9|Add0~10\ ))
...
-- Equation(s):
-- \inst9|Mux30~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~17_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux14~0_combout\ & (\inst3|Mux46~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux14~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux46~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~17_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux14~0_combout\ & (\inst3|Mux62~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst7|Selector3~0_combout\ = ( \inst7|Equal0~0_combout\ & ( \inst7|OUTPUTS~0_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|address_method\(0) & (\inst7|increment\(0))) # (\inst2|address_method\(0) & ((!\inst2|address_method\(1)))))) ) ) ) # ( 
-- !\inst7|Equal0~0_combout\ & ( \inst7|OUTPUTS~0_combout\ & ( (\inst7|increment\(0) & \inst7|nextState.decode3~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000010101010000000001011100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_increment\(0),
...
-- Equation(s):
-- \inst7|Selector8~0_combout\ = (\inst7|Equal0~1_combout\ & (\inst7|Equal6~0_combout\ & \inst7|nextState.selStore~q\))
...
-- Equation(s):
-- \inst7|Selector3~1_combout\ = ( !\inst7|increment\(0) & ( ((!\inst7|Selector8~0_combout\ & (!\inst7|OUTPUTS~0_combout\ & (\inst7|nextState.fetch~q\))) # (\inst7|Selector8~0_combout\ & ((!\inst6|presentJmp~q\) # ((!\inst7|OUTPUTS~0_combout\ & 
-- \inst7|nextState.fetch~q\))))) # (\inst7|Selector3~0_combout\) ) ) # ( \inst7|increment\(0) & ( ((((\inst7|Selector8~0_combout\ & !\inst6|presentJmp~q\)) # (\inst7|nextState.fetch~q\)) # (\inst7|WideOr1~combout\)) # (\inst7|Selector3~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0111011111110111011111111111111101010101111101010101111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_Selector3~0_combout\,
	datab => \inst7|ALT_INV_Selector8~0_combout\,
	datac => \inst7|ALT_INV_WideOr1~combout\,
	datad => \inst7|ALT_INV_nextState.fetch~q\,
	datae => \inst7|ALT_INV_increment\(0),
	dataf => \inst6|ALT_INV_presentJmp~q\,
	datag => \inst7|ALT_INV_OUTPUTS~0_combout\,
...
-- Equation(s):
-- \inst9|Add0~57_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~18\ ))
-- \inst9|Add0~58\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux13~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux45~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux61~4_combout\))) ) + ( \inst9|Add0~18\ ))
...
-- Equation(s):
-- \inst7|Selector8~1_combout\ = ( \inst7|OUTPUTS~1_combout\ & ( (\inst7|nextState.idle~q\ & (!\inst7|nextState.storeAluResult~q\ & !\inst7|nextState.storeData~q\)) ) ) # ( !\inst7|OUTPUTS~1_combout\ & ( (\inst7|nextState.idle~q\ & 
...
-- Equation(s):
-- \inst7|Selector8~2_combout\ = ((!\inst7|Selector8~1_combout\) # ((\inst7|nextState.decode3~q\ & \inst7|Equal0~0_combout\))) # (\inst7|Selector8~0_combout\)

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111100011111111111110001111111111111000111111111111100011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_nextState.decode3~q\,
...
-- Equation(s):
-- \inst7|Equal3~0_combout\ = ( \inst2|opcode\(0) & ( (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & (!\inst2|opcode\(2) & \inst2|opcode\(1)))) ) )
...
-- Equation(s):
-- \inst7|nextState~16_combout\ = ( \inst7|Equal3~0_combout\ & ( \inst7|nextState~15_combout\ & ( (\inst7|nextState.decode3~q\ & (!\inst2|opcode\(5) $ (\inst7|Equal0~2_combout\))) ) ) ) # ( !\inst7|Equal3~0_combout\ & ( \inst7|nextState~15_combout\ & ( 
-- (\inst2|opcode\(5) & (\inst7|nextState.decode3~q\ & \inst7|Equal0~2_combout\)) ) ) ) # ( \inst7|Equal3~0_combout\ & ( !\inst7|nextState~15_combout\ & ( (\inst7|nextState.decode3~q\ & (!\inst2|opcode\(5) $ (\inst7|Equal0~2_combout\))) ) ) ) # ( 
-- !\inst7|Equal3~0_combout\ & ( !\inst7|nextState~15_combout\ & ( (\inst7|nextState.decode3~q\ & ((!\inst2|opcode\(5) & (\inst7|nextState~14_combout\ & !\inst7|Equal0~2_combout\)) # (\inst2|opcode\(5) & ((\inst7|Equal0~2_combout\))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001000010001001000100001000100000000000100010010001000010001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ALT_INV_opcode\(5),
...
-- Equation(s):
-- \inst7|Selector6~0_combout\ = (!\inst7|nextState.storeData~q\ & (!\inst7|nextState.decode~q\ & (!\inst7|nextState.loadAluResult~q\ & !\inst7|nextState.selStore~q\)))
...
-- Equation(s):
-- \inst7|Selector6~1_combout\ = ( \inst7|Selector6~0_combout\ & ( (!\inst7|nextState.execution~q\ & ((!\inst7|nextState.decode3~q\) # ((\inst7|Mux54~0_combout\)))) # (\inst7|nextState.execution~q\ & (((\inst7|Mux54~0_combout\ & 
...
-- Equation(s):
-- \inst7|Selector6~2_combout\ = (\inst7|nextState.execution~q\ & (!\inst7|Equal0~0_combout\ & (!\inst7|Mux54~0_combout\ & !\inst7|OUTPUTS~1_combout\)))
...
\inst7|Selector6~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst7|Selector6~3_combout\ = (((\inst7|ld_r~q\ & !\inst7|Selector6~1_combout\)) # (\inst7|Selector6~2_combout\)) # (\inst7|nextState.storeAluResult~q\)
...
PORT MAP (
	dataa => \inst7|ALT_INV_ld_r~q\,
	datab => \inst7|ALT_INV_nextState.storeAluResult~q\,
	datac => \inst7|ALT_INV_Selector6~1_combout\,
	datad => \inst7|ALT_INV_Selector6~2_combout\,
...
-- Equation(s):
-- \inst9|Add0~53_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~58\ ))
-- \inst9|Add0~54\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux12~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux44~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux60~4_combout\))) ) + ( \inst9|Add0~58\ ))
...
-- Equation(s):
-- \inst9|Mux28~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux12~0_combout\ & (\inst3|Mux44~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux12~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux44~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~53_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux12~0_combout\ & (\inst3|Mux60~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~29_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~54\ ))
-- \inst9|Add0~30\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux11~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux43~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux59~4_combout\))) ) + ( \inst9|Add0~54\ ))
...
-- Equation(s):
-- \inst9|Add0~61_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~30\ ))
-- \inst9|Add0~62\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux10~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux42~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux58~4_combout\))) ) + ( \inst9|Add0~30\ ))
...
-- Equation(s):
-- \inst9|Mux26~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~61_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux10~0_combout\ & (\inst3|Mux42~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux10~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux42~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~61_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux10~0_combout\ & (\inst3|Mux58~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~5_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux9~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux41~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux57~4_combout\))) ) + ( \inst9|Add0~62\ ))
-- \inst9|Add0~6\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux9~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux41~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux57~4_combout\))) ) + ( \inst9|Add0~62\ ))
...
-- Equation(s):
-- \inst9|Mux25~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~5_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux9~0_combout\ & (\inst3|Mux41~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux9~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux41~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~5_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux9~0_combout\ & (\inst3|Mux57~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~45_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux8~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~6\ ))
-- \inst9|Add0~46\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux8~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux40~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux56~4_combout\))) ) + ( \inst9|Add0~6\ ))
...
-- Equation(s):
-- \inst9|Add0~33_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~46\ ))
-- \inst9|Add0~34\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux7~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux39~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux55~4_combout\))) ) + ( \inst9|Add0~46\ ))
...
-- Equation(s):
-- \inst9|Mux23~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux7~0_combout\ & (\inst3|Mux39~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux7~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux39~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~33_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux7~0_combout\ & (\inst3|Mux55~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~37_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~34\ ))
-- \inst9|Add0~38\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux6~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux38~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux54~4_combout\))) ) + ( \inst9|Add0~34\ ))
...
-- Equation(s):
-- \inst9|Mux22~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~37_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux6~0_combout\ & (\inst3|Mux38~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux6~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux38~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~37_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux6~0_combout\ & (\inst3|Mux54~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~41_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~38\ ))
-- \inst9|Add0~42\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux5~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux37~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux53~4_combout\))) ) + ( \inst9|Add0~38\ ))
...
-- Equation(s):
-- \inst9|Add0~49_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~42\ ))
-- \inst9|Add0~50\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux4~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux36~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux52~4_combout\))) ) + ( \inst9|Add0~42\ ))
...
-- Equation(s):
-- \inst9|Mux20~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux36~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux4~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux36~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~49_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux4~0_combout\ & (\inst3|Mux52~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~1_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~50\ ))
-- \inst9|Add0~2\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux3~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux35~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux51~4_combout\))) ) + ( \inst9|Add0~50\ ))
...
-- Equation(s):
-- \inst9|Add0~25_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~2\ ))
-- \inst9|Add0~26\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux2~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux34~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux50~4_combout\))) ) + ( \inst9|Add0~2\ ))
...
-- Equation(s):
-- \inst9|Mux18~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~25_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux2~0_combout\ & (\inst3|Mux34~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux2~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux34~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~25_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux2~0_combout\ & (\inst3|Mux50~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Add0~21_sumout\ = SUM(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~26\ ))
-- \inst9|Add0~22\ = CARRY(( !\inst7|alu_opsel\(4) $ (!\inst9|Mux1~0_combout\) ) + ( (!\inst7|alu_opsel\(0) & (\inst3|Mux33~4_combout\)) # (\inst7|alu_opsel\(0) & ((\inst3|Mux49~4_combout\))) ) + ( \inst9|Add0~26\ ))
...
-- Equation(s):
-- \inst7|Selector1~0_combout\ = ( \inst7|nextState.fetch~q\ & ( ((\inst2|address_method\(0) & (\inst7|nextState.decode3~q\ & \inst7|Equal0~0_combout\))) # (\inst7|increment\(2)) ) ) # ( !\inst7|nextState.fetch~q\ & ( (\inst7|nextState.decode3~q\ & 
-- (((\inst2|address_method\(0) & \inst7|Equal0~0_combout\)) # (\inst7|increment\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000111010101010101011100000101000001110101010101010111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \inst7|ALT_INV_increment\(2),
...
-- Equation(s):
-- \inst7|Selector1~1_combout\ = ( \inst7|Selector8~0_combout\ & ( \inst7|Selector1~0_combout\ & ( (((\inst7|increment\(2) & \inst7|WideOr1~combout\)) # (\inst7|OUTPUTS~0_combout\)) # (\inst6|presentJmp~q\) ) ) ) # ( !\inst7|Selector8~0_combout\ & ( 
-- \inst7|Selector1~0_combout\ & ( ((\inst7|increment\(2) & \inst7|WideOr1~combout\)) # (\inst7|OUTPUTS~0_combout\) ) ) ) # ( \inst7|Selector8~0_combout\ & ( !\inst7|Selector1~0_combout\ & ( ((\inst7|increment\(2) & \inst7|WideOr1~combout\)) # 
-- (\inst6|presentJmp~q\) ) ) ) # ( !\inst7|Selector8~0_combout\ & ( !\inst7|Selector1~0_combout\ & ( (\inst7|increment\(2) & \inst7|WideOr1~combout\) ) ) )
...
PORT MAP (
	...
	datae => \inst7|ALT_INV_Selector8~0_combout\,
	dataf => \inst7|ALT_INV_Selector1~0_combout\,
...
-- Equation(s):
-- \inst9|Mux19~0_combout\ = ( !\inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux3~0_combout\ & (\inst3|Mux35~4_combout\ & \inst7|alu_opsel\(4))) # (\inst9|Mux3~0_combout\ & 
-- ((\inst7|alu_opsel\(4)) # (\inst3|Mux35~4_combout\)))))) ) ) # ( \inst7|alu_opsel\(0) & ( (!\inst7|alu_opsel\(5) & (\inst9|Add0~1_sumout\)) # (\inst7|alu_opsel\(5) & (((!\inst9|Mux3~0_combout\ & (\inst3|Mux51~4_combout\ & \inst7|alu_opsel\(4))) # 
...
-- Equation(s):
-- \inst9|Equal0~0_combout\ = ( !\inst9|result\(13) & ( (!\inst9|result\(0) & (!\inst9|result\(15) & (!\inst9|result\(1) & !\inst9|result\(14)))) ) )
...
PORT MAP (
	...
	datae => \inst9|ALT_INV_result\(13),
	combout => \inst9|Equal0~0_combout\);

\inst9|Equal0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst9|Equal0~1_combout\ = ( !\inst9|result\(7) & ( (!\inst9|result\(4) & (!\inst9|result\(8) & (!\inst9|result\(9) & !\inst9|result\(10)))) ) )
...
-- Equation(s):
-- \inst9|Equal0~2_combout\ = (!\inst9|result\(11) & (!\inst9|result\(3) & (!\inst9|result\(2) & !\inst9|result\(5))))
...
-- Equation(s):
-- \inst9|Equal0~3_combout\ = ( \inst9|Equal0~2_combout\ & ( (!\inst9|result\(12) & (!\inst9|result\(6) & (\inst9|Equal0~0_combout\ & \inst9|Equal0~1_combout\))) ) )
...
-- Equation(s):
-- \inst7|dataSel~1_combout\ = (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & (!\inst2|opcode\(2) & \inst2|opcode\(1))))
...
-- Equation(s):
-- \inst7|dataSel~2_combout\ = ( \inst7|nextState.decode3~q\ & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(0) & (!\inst7|dataSel~0_combout\ & \inst7|dataSel~1_combout\))) ) )
