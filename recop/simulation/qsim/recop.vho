...
SIGNAL \inst|ALT_INV_out_count\ : std_logic_vector(2 DOWNTO 0);
...
-- Equation(s):
-- \inst7|rf_sel[3]~0_combout\ = (!\inst2|opcode\(4) & (!\inst2|opcode\(3) & ((\inst2|address_method\(0)) # (\inst2|address_method\(1)))))
...
-- Equation(s):
-- \inst7|rf_sel[3]~1_combout\ = ( !\reset~input_o\ & ( \inst7|rf_sel[3]~0_combout\ & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(2) & (!\inst2|opcode\(1) & !\inst2|opcode\(0)))) ) ) )
...
-- Equation(s):
-- \inst7|Mux15~0_combout\ = (\inst2|address_method\(1) & !\inst2|address_method\(0))
...
-- Equation(s):
-- \inst7|increment[0]~0_combout\ = ( !\reset~input_o\ & ( (!\inst2|opcode\(5) & (!\inst2|opcode\(2) & (!\inst2|opcode\(1) & !\inst2|opcode\(0)))) ) )
...
-- Equation(s):
-- \inst7|increment[0]~1_combout\ = ( \inst2|address_method\(0) & ( \inst7|increment[0]~0_combout\ & ( (!\inst2|opcode\(4) & (\inst7|increment\(0))) # (\inst2|opcode\(4) & ((!\inst2|opcode\(3) & (\inst7|increment\(0))) # (\inst2|opcode\(3) & 
-- ((!\inst2|address_method\(1)))))) ) ) ) # ( !\inst2|address_method\(0) & ( \inst7|increment[0]~0_combout\ & ( \inst7|increment\(0) ) ) ) # ( \inst2|address_method\(0) & ( !\inst7|increment[0]~0_combout\ & ( \inst7|increment\(0) ) ) ) # ( 
-- !\inst2|address_method\(0) & ( !\inst7|increment[0]~0_combout\ & ( \inst7|increment\(0) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101010101010101010101010101010101010101011101010100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
PORT MAP (
	clk => \clkIn~input_o\,
	d => \inst2|operand\(2),
	asdata => \inst3|Mux45~4_combout\,
	sclr => \reset~input_o\,
	sload => \inst7|ALT_INV_increment\(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst|out_count\(2));
